...
%>
		<br/>
		<label for="starts_with65497811"><fmt:message key="browse.nav.enter"/></label>
...
%>
                <li class="list-group-item">
                    <a href="<%= sharedLink %>&amp;value=<%= URLEncoder.encode(results[i][0], "UTF-8") %>"><%= Utils.addEntities(results[i][0]) %></a>
